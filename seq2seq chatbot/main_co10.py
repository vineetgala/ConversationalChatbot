...
#change this for twitter and cornell corpus
...
if __name__ == "__main__":
    ...
    #comment below statements if you haven't already saved the model
    ...
    model_.train()
    losses=[]
    #change trainx trainY to testX testY for testing
    for epoch in range(num_epochs):
        ...
        losses.append(total_loss/n_iter)
        #saving after every epoch in case it crashes midway
        tl.files.save_npz(model_.all_weights, name='testing{}.npz'.format(epoch))
